...
urlpatterns = [
    ...
    path('baixar-termo-vinculo/<int:equipamento_id>/', views.baixar_termo_vinculo, name='baixar_termo_vinculo'),
    path('termos/equipamentos/', views.listar_equipamentos_alocados, name='listar_equipamentos_alocados'),
    path('termos/os/', views.listar_os_para_termos, name='listar_os_para_termos'),
]
